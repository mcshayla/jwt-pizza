...
import { Franchise, FranchiseList, UsersList, Role, Store, User } from '../service/pizzaService';
...
export default function AdminDashboard(props: Props) {
  ...
  React.useEffect(() => {
    (async () => {
      setUsersList(await pizzaService.getUsers(usersPage, 3, '*'));
    })();
    ...
    response = (
      <View title="Mama Ricci's kitchen">
         <div className="text-start py-8 px-4 sm:px-6 lg:px-8">
          <h3 className="text-neutral-100 text-xl">Users List</h3>
                ...
                <div className="p-1.5 min-w-full inline-block align-middle">
                  <div className="overflow-hidden">
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      {usersList.users.map((user, findex) => {
                        return (
                      ...
                      <tfoot>
                        <tr>
                          <td className="px-1 py-1">
                            <input type="text" ref={filterUsersRef} name="filterFranchise" placeholder="Filter Users List" className="px-2 py-1 text-sm border border-gray-300 rounded-lg" />
                            <button type="submit" data-testid="submit-users-filter" className="ml-2 px-2 py-1 text-sm font-semibold rounded-lg border border-orange-400 text-orange-400 hover:border-orange-800 hover:text-orange-800" onClick={filterUsersList}>
                              Submit
                            </button>
                          </td>
                      ...
                      <tfoot>
                        <tr>
                          <td className="px-1 py-1">
                            ...
                            <button type="submit" data-testid="submit-franchise-filter" className="ml-2 px-2 py-1 text-sm font-semibold rounded-lg border border-orange-400 text-orange-400 hover:border-orange-800 hover:text-orange-800" onClick={filterFranchises}>
                              Submit
                            </button>
                          </td>
                          <td colSpan={4} className="text-end text-sm font-medium">
